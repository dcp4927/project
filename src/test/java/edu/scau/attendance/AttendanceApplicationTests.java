...
class AttendanceApplicationTests {
    ...
    public void run() {
        ...
        gc.setOutputDir("E:\\Users\\student-attendance-system" + "/src/main/java");
        // 生成注释时的作者
        gc.setAuthor("lin");
        //生成后是否打开资源管理器
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/student_attendance?serverTimezone=GMT%2B8");
        ...
        pc.setParent("edu.scau");
        pc.setModuleName("attendance"); //模块名
